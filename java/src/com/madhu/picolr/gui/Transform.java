...
public class Transform extends JApplet implements ItemListener, ActionListener, MouseWheelListener {
...
//		System.out.printf("WheelRotation: %d%n", mwe.getWheelRotation());
		display.zoom(mwe.getWheelRotation());
	}
...
class TransPanel extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		if (!Transform.no2D) {
			...
			TextLayout thisTl = new TextLayout(instruct, new Font("Helvetica",
					0, 10), g2.getFontRenderContext());
			...
			thisTl = new TextLayout(instruct, new Font("Helvetica", 0, 10), g2
			...
			case 0:
				...
				break;
			case 1:
				g2.setPaint(new GradientPaint(0, 0, Color.lightGray, w - 250,
						h, Color.blue, false));
				break;
			case 2:
